...
namespace A_232410101045_utspbo
{
    public partial class Dashboard : Form
    {
        ...
        private void Menambahkanbutton_Click(object sender, EventArgs e)
        {
            this.Hide();
            MenambahkanKontak kontakbaru = new MenambahkanKontak();
            if (kontakbaru.ShowDialog() == DialogResult.OK)
            {
                LoadDataMahasiswa();
            }
